      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md">
          <div className="bg-white dark:bg-slate-800 rounded-2xl border
            ...
            <div className="mb-6">
              <h2 className="text-xl text-center font-bold text-slate-800 dark:text-white">Enter your credentials below</h2>
            </div>
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className="h-11 rounded-xl border-slate-200 dark:border-slate-600
                    ...
                    focus:border-blue-400 focus:ring-blue-400 transition-colors"
                />
              </div>
